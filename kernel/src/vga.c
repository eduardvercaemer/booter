...
static void gcw_setreset(u8 planes);
static void gcw_enable_setreset(u8 planes);
static void gcw_color_compare(u8 planes);
static void gcw_data_rotate(u8 logical, u8 count);
static void gcw_read_map_select(u8 plane);
static void gcw_graphics_mode(u8 shift256, u8 shiftReg, u8 hostOE, u8 readMode, u8 writeMode);
static void gcw_misc(u8 mem_map, u8 chainOE, u8 alphaDis);
static void gcw_color_dontcare(u8 planes);
static void gcw_bitmask(u8 mask);
...
static void seqw_map_mask(u8 planes);
// TODO: register read functions
